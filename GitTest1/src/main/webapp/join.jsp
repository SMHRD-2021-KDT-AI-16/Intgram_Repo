			...
			<aside class="menu">
				...
				<section class="menu-wrapper">
					<nav class="side-menu">
						...
						<a class="menu-link" href="netzero.jsp">
				...
				<form action="JoinService" method="post">
					...
					<section class="join-input">
						<div class="join-input__inputs">
							...
							<input name="com_num" type="text" id="bizID" required />
						</div>
						...
						<div class="join-input__inputs">
							...
							<input name="mem_name"type="text" id="name" required />
						</div>
						...
						<div class="join-input__inputs">
							...
							<input name="position" type="text" id="company" required />
						</div>

						<div class="join-input__inputs">
							<label>
								<span class="asterisk"></span>
								<span>Position Titles</span>
							</label>
