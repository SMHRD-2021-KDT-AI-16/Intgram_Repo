...
<body>
		...
		<header class="menu">
			...
			<section class="menu-wrapper">
				<nav class="side-menu">
					...
					<a class="menu-link" href="homecopy.jsp"> <i
						class="fa-solid fa-house"></i> <span>Home</span>
					</a> <a class="menu-link dropdown-toggle" href="netzero_carbon.jsp">
						<i class="fa-solid fa-seedling"></i> <span>Carbon Dashboard</span>
					</a> <a class="menu-link dropdown-toggle" href="netzero_climate.jsp">
						<i class="fa-solid fa-seedling"></i> <span>Climate
							Dashboard</span>
			...
			<section id="login-area" class="contents-header__login">
				<nav class="login-menu">
					...
					<c:if test="${member == null }">
						<!-- 로그아웃일 때 -->
						<a class="login-menu-link" href="login.jsp"> <i
							class="fa-regular fa-circle-user"></i> <span>Login</span>
						</a>
						<a class="login-menu-link" href="components/join.html"> <i
	...
	<main class="main-container">
		<div class="home-main">
			...
			<div class="cloud-img">
				<img src="imgs/cloud1.png" alt="" class="cloud1" /> <img
					src="imgs/cloud2.png" alt="" class="cloud2" /> <img
					src="imgs/cloud3.png" alt="" class="cloud3" />
			</div>
			<div class="tree-img">
				<img src="imgs/tree1.png" alt="" class="tree1" /> <img
					src="imgs/tree2.png" alt="" class="tree2" /> <img
					src="imgs/tree3.png" alt="" class="tree3" /> <img
					src="imgs/tree4.png" alt="" class="tree4" /> <img
					src="imgs/tree5.png" alt="" class="tree5" /> <img
					src="imgs/tree6.png" alt="" class="tree6" /> <img
					src="imgs/tree7.png" alt="" class="tree7" /> <img
					src="imgs/tree8.png" alt="" class="tree8" /> <img
					src="imgs/tree9.png" alt="" class="tree9" /> <img
					src="imgs/tree10.png" alt="" class="tree10" /> <img
					src="imgs/tree11.png" alt="" class="tree11" /> <img
					src="imgs/tree12.png" alt="" class="tree12" />
			</div>
			<div class="earth-img">
